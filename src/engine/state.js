...
export const channelCost = (c)=> c.type==='INSTANT' ? 1 : 2; // Channeling cost
...
export const newGame=()=>{
  ...
  return { you:newSide(), ai:newSide(), aetherflowPool: pool, aetherflow: pool.splice(0,5),
    trance:[{label:'Calm',at:4},{label:'Focus',at:3},{label:'Trance',at:2},{label:'Zenith',at:1}],
    turn:'YOU', animations:[] };
};