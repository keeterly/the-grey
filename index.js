...
function cardHTML(c){
  if (!c){
    return `<div class="title">Empty</div><div class="type">—</div><div class="divider"></div><div class="pip-track"></div><div class="textbox">—</div>`;
  }
...
async function render(){
  ...
  /* ----- HAND with deal + restored interaction wiring ----- */
  if (handEl){
